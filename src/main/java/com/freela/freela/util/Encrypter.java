...
public class Encrypter {
    ...
    @Value("${freela-encription-key}")
    private static String encryptionKey="0000";
    //private static final byte[] key = AppServletContextListener.getServletContext().getInitParameter("key").getBytes();
    private static final SecretKey aesKey = new SecretKeySpec(encryptionKey.getBytes(StandardCharsets.UTF_8), "AES");
